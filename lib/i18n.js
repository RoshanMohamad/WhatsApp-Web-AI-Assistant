...
(function (root, factory) {
  ...
  const MESSAGES = {
    en: {
      ...
      'notify.contextInvalidated':
        'The extension was updated or reloaded. Refresh this page to keep using it.',
      'notify.noBackgroundReply':
        'The extension background worker did not respond. Try reloading the page.',
    ...
    ta: {
      ...
      'notify.contextInvalidated':
        'நீட்டிப்பு புதுப்பிக்கப்பட்டது அல்லது மீண்டும் ஏற்றப்பட்டது. தொடர்ந்து பயன்படுத்த இந்தப் பக்கத்தைப் புதுப்பிக்கவும்.',
      'notify.noBackgroundReply':
        'நீட்டிப்பின் பின்னணிப் பணி பதிலளிக்கவில்லை. பக்கத்தை மீண்டும் ஏற்ற முயற்சிக்கவும்.',
